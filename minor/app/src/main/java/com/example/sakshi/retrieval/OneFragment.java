...
public class OneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        neft2 = neft.child("day2").child("9am-12pm");
        Firebase neft4= neft.child("day1").child("9-12");


        neft4.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot snapshot) {
                Log.e("neft4","in1neft4");
                j=0;
    ...
    private void populateList() {
        Log.e("ahaaaaaaaaaaa","hatt");
        ListView lv=(ListView)getActivity().findViewById(R.id.list1);
